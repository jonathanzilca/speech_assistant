...
IFontDisp = Font
__all__ = [ 'FONTNAME', 'IFontEventsDisp', 'IFont',
           'OLE_YSIZE_HIMETRIC', 'FontEvents', 'LoadPictureConstants',
           'OLE_XPOS_PIXELS', 'IPicture', 'OLE_YPOS_CONTAINER',
           'Checked', 'OLE_CANCELBOOL', 'OLE_XSIZE_CONTAINER',
           'Color', 'VgaColor', 'OLE_YPOS_HIMETRIC', 'Default',
           'OLE_ENABLEDEFAULTBOOL', 'OLE_XSIZE_PIXELS',
           'OLE_YPOS_PIXELS', 'OLE_HANDLE', 'OLE_XPOS_CONTAINER',
           'OLE_YSIZE_CONTAINER', 'OLE_YSIZE_PIXELS',
           'OLE_OPTEXCLUSIVE', 'IFontDisp', 'Picture', 'Gray',
           'Monochrome', 'OLE_XPOS_HIMETRIC', 'FONTITALIC',
           'FONTUNDERSCORE', 'StdPicture', 'Unchecked', 'StdFont',
           'OLE_XSIZE_HIMETRIC', 'FONTSIZE', 'OLE_TRISTATE',
           'OLE_COLOR', 'FONTBOLD', 'Font', 'IPictureDisp',
           'FONTSTRIKETHROUGH']
